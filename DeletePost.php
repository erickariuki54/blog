...
if (isset($_POST["submit"])){
    ...
    $target = "Upload/".basename($_FILES["Image"]['name']);
        ...
        global $conn;
        $DeleteFroUrl=$_GET['Delete'];
        $Query = "DELETE FROM admin_panel WHERE id='$DeleteFroUrl'";
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <div>
                    ...
                    ?>
                    <form action="DeletePost.php?Delete=<?php echo htmlentities($searchQueryParameter); ?>" method="post" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <input disabled value="<?php echo $TitleToBeUpdated; ?>" class="form-control" type="text" name="title" id="title" placeholder="Title">
                                ...
                                <span class="FieldInfo">Existing Category: </span>
                                    ...
                                    <select name="Category" id="categoryselect" class="form-control" disabled>
                                    <?php 
                                    global $conn;
                                    ...
                                    <img src="./Upload/<?php echo $ImageToBeUpdated;?>" alt="" width="70" height="70px"> 
                                        ...
                                        <input disabled id="Imageselect" class="form-control" type="file" name="Image">
                                    </div>
                                    <div class="form-group">
                                        <span> <span class="FieldInfo">Author</span> :<?php echo $authorToBeUpdated; ?></span>
                                        
                                    </div>
                                    <div class="form-group">
                                        <label class="FieldInfo" for="postarea">Post</label>
                                        <textarea id="postarea" class="form-control"  name="Post" disabled>
